...
from TestCase2Testlink.common.logger import Log
...
class TestLinkOperate:
    ...
    def download(self, father_id):
        ...
        for data in self.tlc.getTestCasesForTestSuite(father_id, True, 'full'):
            ...
            datas.append((tsuite_name,name, preconditions, '；'.join(actions), '；'.join(expected_results),
